...
import com.xjy.practice.设计模式.依赖倒置原则.实现类.IntelCpu;
import com.xjy.practice.设计模式.依赖倒置原则.实现类.KingMemory;
import com.xjy.practice.设计模式.依赖倒置原则.实现类.XjHardDisk;
...
public class Test {
  ...
  public static void main(String[] args) {
    //
    HardDisk hardDisk = new XjHardDisk();
