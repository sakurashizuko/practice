package com.xjy.practice.common.util;

import com.xjy.practice.common.constant.CodeEnums;
import lombok.Data;
...
public class ResponseUtils {
  ...
  public static ResponseUtils success() {
    return new ResponseUtils(null, CodeEnums.SUCCESS_CODE);
  }
  ...
  public static ResponseUtils error() {
    return new ResponseUtils(null, CodeEnums.ERROR_CODE);
  }
  ...
  public static ResponseUtils msg(String msg) {
    return new ResponseUtils(null, CodeEnums.ERROR_MSG.getCode(), msg);
  }

  public static ResponseUtils notLogin() {
    return new ResponseUtils(null, CodeEnums.NOT_LOGIN);
  }

  public static ResponseUtils noResult() {
    return new ResponseUtils(null, CodeEnums.NO_RESULT);
  }
